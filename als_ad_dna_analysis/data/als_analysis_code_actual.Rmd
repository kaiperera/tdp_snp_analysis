...
```{r READ IN DATA}
als_snps_to_start <- read.csv(here::here("als_ad_dna_analysis/data/als_snps_to_start.csv"))
...
```{r READ IN DEEPCLIP}
deepclip_data <- stream_in(file("C:/Users/Kai/Desktop/tdp_snp_analysis/als_ad_dna_analysis/data/als_gwas1.json"))
```
...
als_gwas1 <- jsonlite::fromJSON("C:/Users/Kai/Desktop/tdp_snp_analysis/als_ad_dna_analysis/data/als_gwas1.json")$predictions
